...
[CreateAssetMenu(menuName = "Field/Transform/Grass", fileName = "Grass Transformer", order = 0)]
public class CellGrassTransformer : CellTransformerBase
{
    [SerializeField] private float _positionY = 0f;
    [SerializeField] private Color _color;
    [SerializeField] private float _duration = 1f;

    public override ECellType TransformType => ECellType.Grass;
