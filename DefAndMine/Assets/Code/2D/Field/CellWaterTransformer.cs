...
[CreateAssetMenu(menuName = "Field/Transform/Water", fileName = "Water Transformer", order = 0)]
public class CellWaterTransformer : CellTransformerBase
{
    [SerializeField] private float _positionY = -0.5f;
    [SerializeField] private Color _color;
    [SerializeField] private float _duration = 1f;
    
    public override ECellType TransformType => ECellType.Water;
